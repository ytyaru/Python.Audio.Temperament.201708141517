...
#        print([f for f in self.__calcMinusInOctave()])
#        print([f for f in self.__calcPlusInOctave()])
#        self.__Frequencies.extend([f*2 for f in self.__calcMinusInOctave()])
    ...
    # return: [4, 短7, 短3, 短6, 短2] 減5は増4と同じはずだがピタゴラス音律においては別の音になってしまう（ピタゴラスコンマ）
    # return: [4, 短7, 短3, 短6, 短2, 減5]
    # 減5, 短2, 短6, 短3, 短7, 4
    def __calcMinusInOctave(self):
        for x, y in ((1,1), (2,2), (3,2), (4,3), (5,3)):
#        for x, y in ((1,1), (2,2), (3,2), (4,3), (5,3), (6,4)):
